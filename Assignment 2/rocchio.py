...
def dumpdicts(idf_dict, filemap):
    with open("idf_dict_new.json", "w") as outfile:
        json.dump(idf_dict, outfile)
    with open("filemap_new.json", "w") as outfile:
...
if __name__ == "__main__":
    ...
    # idf_dict, filemap = get_idf_dict_new2()
    ...
    updated_queries = rocchio_updateQueriesTest(1.0, 0.25, 0.15)
